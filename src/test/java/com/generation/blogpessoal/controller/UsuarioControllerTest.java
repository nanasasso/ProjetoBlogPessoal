...
public class UsuarioControllerTest {
	...
	public void deveCriarUmUsuario() {
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Paulo Antuness", "paulo_antunes@email.com.br", "13465278", "-"));
	...
	public void naoDeveDuplicarUsuario() {
		usuarioService.cadastrarUsuario(new Usuario(0L, "Denise Paulo", "denise@email.com", "596192", "-"));
		
		HttpEntity<Usuario> corpoRequisicao = new HttpEntity<Usuario>(new Usuario(0L, "Denise Paulo", "denise@email.com", "596192", "-"));
